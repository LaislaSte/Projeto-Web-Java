...
<body>
	<%  Usuario usuLogado = (Usuario) session.getAttribute("UsuarioLogado");
		...
		if (usuLogado != null && pessoaLogada != null) { 
			...
			List<LogradourosPessoas> listaLogPes = contLogPes.listarPorPessoa(pessoaLogada);
			List<CartoesPessoas> listaCarPes = contCarPes.listarPorPessoa(pessoaLogada);
			List<ComprasPessoas> listaComPes = contComPes.listarPorPessoa(pessoaLogada);
		        ...
		        <main>
		            ...
		            <div class="row g-5 row-cols-1 row-cols-md-2">
		                ...
		                <div class="col-md-8 py-3 bg-body-tertiary">
		                    <h1 class="text-center mb-3">Cartoes, Logradouros e Compras</h1>
